...
const Header = ({ toggleMenuVisibility }) => {
  ...
  return (
    <header className='flex flex-col'>
      <div className='flex flex-row gap-8 p-8 justify-center items-center border-b border-solid border-b-grey-500'>
        <button className='w-auto sm:w-1/6 flex justify-start' onClick={toggleMenuVisibility} {...createAttr(t('menu.open'))}>
          <FontAwesomeIcon icon={faBars} />
        </button>
        <Link href={'/'} {...createAttr(t('header.title'))}>
