        ...
        <div className='mx-8 sm:mx-auto p-8 sm:w-2/6 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex gap-4 pr-4 items-center'>
              <input className={'rounded-lg p-2 border border-black dark:border-white border-solid flex-1'} style={{ outline: emailValid ? '#22c55e solid 2px' : 'rgb(239 68 68) solid 2px' }} type='email' id='username' name='username' onChange={handlerChangeEmail} />
