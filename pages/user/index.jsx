...
const Index = () => {
  ...
  return (
    <Container>
      {user && (
        <div className='relative h-30-screen w-screen overflow-hidden flex justify-center items-center border-y border-y-black dark:border-y-white border-y-solid'>
      ...
      <>
        {visits && visits.length !== 0 && (
          <>
            <div className='p-8 border-y border-y-black dark:border-y-white border-y-solid'>
            ...
            <div className='p-8 gap-8 flex flex-col'>
              {visits &&
                visits.map((item) => {
                  return (
                    <div key={item.id_visit} className='relative rounded-lg overflow-hidden h-10-screen p-8 gap-4 flex justify-between items-center border border-solid dark:border-white border-black'>
                      ...
                      <button className='rounded-md border border-solid border-black dark:border-white py-2 px-4' onClick={() => router.push(`/visits/delete/${item.id_visit}`)}>
